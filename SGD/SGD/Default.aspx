                                            ...
                                            <div class="card-block">
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <p class="text-center">  <label id="mensages" runat="server" visible="false" style="font-size:14px" class=" label label-danger">Email ou Senha Incorrecta, por favor Tente Novamente!</label></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                               ...
                                               <%--         <img src="assets/images/auth/logo.png" alt="logo.png">--%>
                                                    ...
                                                    <div class="auth-box">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <asp:TextBox ID="inputUsuario" AutoCompleteType="None" CssClass="form-control form-control-info" TextMode ="Email"  placeholder="Login" runat="server"></asp:TextBox>
                                                            <span class="md-line"></span>
                                                        </div>
                                                        <div class="input-group">

                                                             <asp:TextBox ID="inputPassword" AutoCompleteType="None" CssClass="form-control form-control-info" TextMode ="Password"  placeholder="Password" runat="server"></asp:TextBox>
                                                            <span class="md-line"></span>
                                                        </div>
                                                        ...
                                                        <div class="row m-t-15">
                                                            <div class="col-md-12">
                                                                ...
                                                                <asp:Button ID="Button1" runat="server" CssClass="btn btn-info btn-md btn-block waves-effect text-center" Text="Entrar" OnClick="Button1_Click" />
                                                                 </div>
